                ...
                <div class="p-6 text-black-600">
                    <body class="antialiased sans-serif">
                        <div
                            ...
                            <form action="<?php echo e(url('factures/factures-ajout', [])); ?>" method="post" class="">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="flex flex-wrap justify-between mb-8">
                                            ...
                                            $(document).ready(function(){
                                                $('.cltadr').keyup(function(){
                                                    ...
                                                    if(query != '')
                                                    {
                                                        var _token = $('input[name="_token"]').val();
                                                        $.ajax({
                                                        url:"<?php echo e(route('autoadresse')); ?>",
                                                        method:"GET",
                                                        data:{query:query, _token:_token},
                                                        success:function(data){
                                                        $('#client_list1').fadeIn();
                                    ...
                                    <div class="w-full md:w-1/3">
                                        ...
                                        <input class="mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" value=<?php echo e(auth()->user()->name_entreprise); ?> readonly >

                                        <input class="mb-1 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" value=<?php echo e(auth()->user()->adresse_entreprise); ?> readonly >
                                        ...
                                        $(document).ready(function(){
                                            $('#produitnom').keyup(function(){
                                                ...
                                                if(query != '')
                                                {
                                                    var _token = $('input[name="_token"]').val();
                                                    $.ajax({
                                                    url:"<?php echo e(route('autoaprod')); ?>",
                                                    method:"GET",
                                                    data:{query:query, _token:_token},
                                                    success:function(data){
                                                    $('#prod_list').fadeIn();
...
<?php endif; ?>
<?php /**PATH C:\LaravelApp\AIE\proj\resources\views/factures/Ajout.blade.php ENDPATH**/ ?>