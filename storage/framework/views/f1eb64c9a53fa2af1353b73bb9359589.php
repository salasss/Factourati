                ...
                <div class="p-6 text-black-600">
                    <body class="antialiased sans-serif">
                        <div
                            ...
                            x-data="Factures()"
                            x-init="generateFactureNumber(111111, 999999);"
                            x-cloak
                        >
                            ...
                            <div class="flex mb-8 justify-between">
                                <div class="w-2/4">
                                    <div class="mb-2 md:mb-1 md:flex items-center">
                                        ...
                                        <div class="flex-1">
                                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" id="inline-full-name" type="text" placeholder="eg. #INV-100001" x-model="FactureNumber">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2 md:mb-1 md:flex items-center">
                                        ...
                                        <span class="mr-4 inline-block md:block">:</span>
                                        <div class="flex-1">
                                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 js-datepicker" type="text" id="datepicker1" placeholder="eg. 17 Feb, 2020" x-model="FactureDate" x-on:change="FactureDate = document.getElementById('datepicker1').value" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-2 md:mb-1 md:flex items-center">
                                        ...
                                        <span class="mr-4 inline-block  md:block">:</span>
                                        <div class="flex-1">
                                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-48 py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 js-datepicker-2" id="datepicker2" type="text" placeholder="eg. 17 Mar, 2020" x-model="FactureDueDate" x-on:change="FactureDueDate = document.getElementById('datepicker2').value" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div>
                            ...
                            function Factures() {
                                return {
                                    ...
                                    generateFactureNumber(minimum, maximum) {
                                        ...
                                        this.FactureNumber = '#INV-'+ randomNumber;
                                    },
...
<?php endif; ?>
<?php /**PATH C:\LaravelApp\Proj\proj\resources\views/factures/Ajout.blade.php ENDPATH**/ ?>