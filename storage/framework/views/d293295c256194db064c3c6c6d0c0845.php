                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-slate-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="flex items-center px-6 py-4 space-x-3">
                                            <a href="<?php echo e(url('Produit/Produits-modifier/'.$Product ->id)); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" >Modifier </a>
...
<?php endif; ?>
<?php /**PATH C:\LaravelApp\AIE\proj\resources\views/produits/Index.blade.php ENDPATH**/ ?>