    ...
    <div class="py-12">
         <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <a href="<?php echo e(url('Clients/Clients-ajout')); ?>" class="grid place-items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">+Ajouter un produit</a>
...
<?php endif; ?>
<?php /**PATH C:\LaravelApp\Proj\proj\resources\views/Clients/index.blade.php ENDPATH**/ ?>