         ...
         <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-wrap -mx-3 mb-6 space-x-7 justify-center">
                    <a href="<?php echo e(url('factures/factures-ajout')); ?>" class="w-full md:w-1/4  grid place-items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">+Ajouter une facture</a>
                    <a href="<?php echo e(url('/factures/factures-archive')); ?>" class="w-full md:w-1/4  grid place-items-center text-white  bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Voir les factures archiver</a>
                </div>
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-slate-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4"><?php echo e($Facture ->valeur_tva); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\LaravelApp\AIE\proj\resources\views/factures/index.blade.php ENDPATH**/ ?>