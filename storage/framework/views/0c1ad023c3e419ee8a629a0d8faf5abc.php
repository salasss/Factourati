        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <nav class="navbar">
                ...
                <div class="nav-connection">
                    <button class="btn-connection" ><span> <?php if(Route::has('login')): ?>
                        <div>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/Compte')); ?>" >Compte</a>
                            <?php else: ?>
            ...
            <header>
                <section class="s1">
                    <div >
                        ...
                        <a href='inscription'> <button class="btn-insc"><span> <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" >commencer dès maintenant</a>
                        <?php endif; ?> </span></button></a>
                    </div>
                </section>
            </header>
...
<?php /**PATH C:\LaravelApp\AIE\proj\resources\views/welcome.blade.php ENDPATH**/ ?>