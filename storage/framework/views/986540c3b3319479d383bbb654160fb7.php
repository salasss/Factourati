    ...
    <div class="py-12">
         <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <a href="<?php echo e(url('Categorie/Categorie-ajout')); ?>" class="grid place-items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">+Ajouter une categorie</a>
                ...
                <div class="mt-6 p-6 ">
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="bg-slate-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4"><?php echo e($Categorie ->Nom); ?></td>

                                        <td class="flex items-center px-6 py-4 space-x-3">
                                            <a href="<?php echo e(url('Categorie/Categorie-modifier/'.$Categorie ->id)); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" >Modifier </a>
...
<?php endif; ?>
<?php /**PATH C:\LaravelApp\AIE\proj\resources\views/categorie/Index.blade.php ENDPATH**/ ?>